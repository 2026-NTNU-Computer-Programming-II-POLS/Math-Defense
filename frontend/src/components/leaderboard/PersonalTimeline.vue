...
.pt-axis-label { fill: var(--axis); font-size: var(--text-xs); }
.pt-line { stroke: var(--gold); stroke-width: 1.5; }
.pt-dot { fill: var(--gold-bright); }
.pt-pb-marker { fill: var(--gold); color: var(--gold); text-shadow: var(--gold-shadow); font-size: var(--text-sm); font-weight: bold; }
...
.pt-row-date { color: var(--axis); text-shadow: var(--gold-shadow); font-size: var(--text-xs); }
</style>
